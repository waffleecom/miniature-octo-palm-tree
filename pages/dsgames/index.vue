<template>
  <div>
    ...
    <!---<h4 style="text-align: center; padding: 0px 60px 0px 60px">
      {{ $t('gamesds.par1') }}
      <a
        href="https://github.com/DS-Homebrew/TWiLightMenu"
        target="_blank"
        style="color: primary; text-decoration: none"
        >TwilightMenu++</a
      >. {{ $t('gamesds.par2') }}
      <a
        href="https://wiki.ghosteshop.com/tutorialnds.html"
        target="_blank"
        style="color: primary; text-decoration: none"
        >{{ $t('gamesds.tutorial') }}</a
      >.
    </h4>--->
    <v-container>
      <v-card>
